...
path("student/save_notification",student_save_notification, name="student_save_notification"),  # type: ignore
...
path("staff/feedback_save",staff_feedback_save, name="staff_feedback_reply_save"),  # type: ignore
